...
export const healthyMukubaOperationsLayout: LayoutProfile = {
  ...
  positions: {
    [ZONE_ENTERPRISE]: { x: 140, y: 160 },
    [ZONE_DMZ]: { x: 410, y: 160 },
    [ZONE_OPERATIONS]: { x: 660, y: 290 },
    [ZONE_CRUSHER]: { x: 900, y: 470 },
    [EDGE_FIREWALL]: { x: 190, y: 170 },
    [CORE_01]: { x: 590, y: 210 },
    [CORE_02]: { x: 720, y: 210 },
    [HISTORIAN]: { x: 350, y: 150 },
    [JUMP_SERVER]: { x: 460, y: 150 },
    [SCADA_01]: { x: 570, y: 350 },
    [SCADA_02]: { x: 700, y: 350 },
    [CRUSHER_DIST]: { x: 900, y: 360 },
    [CRUSHER_PLC]: { x: 850, y: 520 },
    [CRUSHER_HMI]: { x: 950, y: 520 },
    [PROBE]: { x: 800, y: 350 },
    [HISTORIAN_SERVICE]: { x: 350, y: 250 },
    [CRUSHER_CONTROL]: { x: 670, y: 500 },
    [CRUSHER_PROCESS]: { x: 900, y: 660 },
  },
};
