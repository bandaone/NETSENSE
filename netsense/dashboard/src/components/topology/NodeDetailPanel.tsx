    ...
    >
      <div className="flex-none border-b border-[var(--color-border-default)] px-5 py-4">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <h2 className="mt-2 truncate text-[17px] font-semibold text-white">{node.displayName}</h2>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <section className="border-b border-[var(--color-border-subtle)] px-5 py-4">
          <h3 className="text-[12px] font-semibold text-white">Organisational context</h3>
          <dl className="mt-2">
        ...
        <section className="border-b border-[var(--color-border-subtle)] px-5 py-4">
          <h3 className="text-[12px] font-semibold text-white">Current assessment</h3>
          <dl className="mt-2">
        ...
        <section className="border-b border-[var(--color-border-subtle)] px-5 py-4">
          <h3 className="text-[12px] font-semibold text-white">Connected context</h3>
        ...
        {node.assessment.managementState === 'passive_only' && (
          <section className="flex gap-3 border-b border-[var(--color-border-subtle)] px-5 py-4">
            ...
            <div>
              <h3 className="text-[12px] font-semibold text-white">Passive-only monitoring</h3>
        ...
        <details className="border-b border-[var(--color-border-subtle)] px-5 py-4">
          <summary className="text-[12px] font-semibold text-white">Technical identity and interfaces</summary>
          <dl className="mt-3">
        ...
        <details className="px-5 py-4">
          <summary className="text-[12px] font-semibold text-white">Evidence details and limitations</summary>
